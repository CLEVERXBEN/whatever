...
# -------------------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------------------
#  ------------------ ReCoredV1 Strategy by maxouww based on the CoreStrategy. --------------------
# -------------------------------------------------------------------------------------------------
class ReDeCoredV1StopLossUpdated(IStrategy):
    INTERFACE_VERSION = 2
    ...
    # Stoploss personnalisé
    use_custom_stoploss = False
    # Exécuter "populate_indicators()" uniquement pour les nouvelles bougies
    process_only_new_candles = True

    # Nombre de bougies nécessaires avant d'obtenir des signaux valides
    ...
    buy_params = {
        ...
        "buy_bb20_close_bblowerband_safe_1": 0.99,
        "buy_bb20_close_bblowerband_safe_2": 0.982,
        "buy_bb20_volume": 29,
        "buy_bb40_bbdelta_close": 0.031,
        "buy_bb40_closedelta_close": 0.021,
        "buy_bb40_tail_bbdelta": 0.264,
    ...
    sell_params = {
        ...
        "high_offset": 1.022,
        "sell_custom_roi_profit_1": 0.03,
        "sell_custom_roi_profit_2": 0.06,
        "sell_custom_roi_profit_3": 0.16,
        "sell_custom_roi_profit_4": 0.45,
        "sell_custom_roi_profit_5": 0.01,
        "sell_custom_roi_rsi_1": 55.11,
        "sell_custom_roi_rsi_2": 48.6,
        "sell_custom_roi_rsi_3": 56,
        "sell_custom_roi_rsi_4": 58,
        "sell_custom_stoploss_1": -0.11,
        "sell_trail_down_1": 0.044,
        "sell_trail_down_2": 0.149,
        "sell_trail_profit_max_1": 0.42,
        "sell_trail_profit_max_2": 0.2,
        "sell_trail_profit_min_1": 0.239,
        "sell_trail_profit_min_2": 0.059,
    ...
    # Define parameters
    smaoffset_buy_condition_0_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=False, load=True)
    smaoffset_buy_condition_1_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=False, load=True)
    smaoffset_sell_condition_0_enable = CategoricalParameter([True, False], default=False, space="sell", optimize=False, load=True)
    ...
    low_offset = DecimalParameter(0.9, 0.99, default=0.934, space="buy", optimize=True, load=True)
    high_offset = DecimalParameter(0.99, 1.1, default=1.022, space="sell", optimize=True, load=True)
    ...
    ewo_low = DecimalParameter(-20.0, -8.0, default=-15.53, space="buy", optimize=True, load=True)
    ewo_high = DecimalParameter(2.0, 12.0, default=6.455, space="buy", optimize=True, load=True)
    rsi_buy = IntParameter(30, 70, default=43, space="buy", optimize=True, load=True)
    v6_buy_condition_0_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=False, load=True)
    ...
    v8_buy_condition_1_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=False, load=True)
    v8_buy_condition_2_enable = CategoricalParameter([True, False], default=True, space="buy", optimize=False, load=True)
    v8_buy_condition_3_enable = CategoricalParameter([True, False], default=False, space="buy", optimize=False, load=True)
    ...
    sell_custom_roi_profit_1 = DecimalParameter(0.01, 0.03, default=0.03, space="sell", decimals=2, optimize=True, load=True)
    sell_custom_roi_rsi_1 = DecimalParameter(40.0, 56.0, default=55.11, space="sell", decimals=2, optimize=True, load=True)
    sell_custom_roi_profit_2 = DecimalParameter(0.01, 0.20, default=0.06, space="sell", decimals=2, optimize=True, load=True)
    sell_custom_roi_rsi_2 = DecimalParameter(42.0, 56.0, default=48.6, space="sell", decimals=2, optimize=True, load=True)
    sell_custom_roi_profit_3 = DecimalParameter(0.15, 0.30, default=0.16, space="sell", decimals=2, optimize=True, load=True)
    sell_custom_roi_rsi_3 = DecimalParameter(44.0, 58.0, default=56, space="sell", decimals=2, optimize=False, load=True)
    sell_custom_roi_profit_4 = DecimalParameter(0.3, 0.7, default=0.45, space="sell", decimals=2, optimize=True, load=True)
    sell_custom_roi_rsi_4 = DecimalParameter(44.0, 60.0, default=58, space="sell", decimals=2, optimize=False, load=True)
    sell_custom_roi_profit_5 = DecimalParameter(0.01, 0.1, default=0.01, space="sell", decimals=2, optimize=True, load=True)
    sell_trail_profit_min_1 = DecimalParameter(0.1, 0.25, default=0.239, space="sell", decimals=3, optimize=True, load=True)
    sell_trail_profit_max_1 = DecimalParameter(0.3, 0.5, default=0.42, space="sell", decimals=2, optimize=True, load=True)
    sell_trail_down_1 = DecimalParameter(0.04, 0.1, default=0.044, space="sell", decimals=3, optimize=True, load=True)
    sell_trail_profit_min_2 = DecimalParameter(0.01, 0.1, default=0.059, space="sell", decimals=3, optimize=True, load=True)
    sell_trail_profit_max_2 = DecimalParameter(0.08, 0.25, default=0.2, space="sell", decimals=2, optimize=True, load=True)
    sell_trail_down_2 = DecimalParameter(0.04, 0.2, default=0.149, space="sell", decimals=3, optimize=True, load=True)
    sell_custom_stoploss_1 = DecimalParameter(-0.15, -0.03, default=-0.11, space="sell", decimals=2, optimize=True, load=True)
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            ...
            ['smaoffset_buy_condition_0_enable', 'buy_tag']] = (bool('1'), 'buy_signal_smaoffset_0')
        ...
        dataframe.loc[
            ...
            ['smaoffset_buy_condition_1_enable', 'buy_tag']] = (bool('1'), 'buy_signal_smaoffset_1')
        ...
        dataframe.loc[
            ...
            ['v8_buy_condition_0_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v8_0')
        ...
        dataframe.loc[
            ...
            ['v8_buy_condition_1_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v8_1')
        ...
        dataframe.loc[
            ...
            ['v8_buy_condition_2_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v8_2')
        ...
        dataframe.loc[
            ...
            ['v8_buy_condition_3_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v8_3')
        ...
        dataframe.loc[
            ...
            ['v8_buy_condition_4_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v8_4')
        ...
        dataframe.loc[
            ...
            ['v9_buy_condition_1_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v9_1')
        ...
        dataframe.loc[
            ...
            ['v9_buy_condition_2_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v9_2')
        ...
        dataframe.loc[
            ...
            ['v9_buy_condition_3_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v9_3')
        ...
        dataframe.loc[
            ...
            ['v9_buy_condition_4_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v9_4')
        dataframe.loc[
            (
                (dataframe["close"] > dataframe["ema_200"])
                & (dataframe["close"] > dataframe["ema_200_1h"])
            ...
            ['v9_buy_condition_5_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v9_5')
        dataframe.loc[
            (
                (dataframe["ema_26"] > dataframe["ema_12"])
                & (
            ...
            ['v9_buy_condition_6_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v9_6')
        dataframe.loc[
            (
            ...
            ['v9_buy_condition_7_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v9_7')
        dataframe.loc[
            (
            ...
            ['v9_buy_condition_8_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v9_8')
        dataframe.loc[
            (
            ...
            ['v9_buy_condition_9_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v9_9')
        dataframe.loc[
            (
                (dataframe["close"] < dataframe["sma_5"])
                & (dataframe["ssl_up_1h"] > dataframe["ssl_down_1h"])
            ...
            ['v9_buy_condition_10_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v9_10')
        dataframe.loc[
            (
                (dataframe["close"] > dataframe["ema_200"])
                & (dataframe["close"] > dataframe["ema_200_1h"])
            ...
            ['v6_buy_condition_0_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v6_0')
        ...
        dataframe.loc[
            ...
            ['v6_buy_condition_1_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v6_1')
        ...
        dataframe.loc[
            ...
            ['v6_buy_condition_2_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v6_2')
        ...
        dataframe.loc[
            ...
            ['v6_buy_condition_3_enable', 'buy_tag']] = (bool('1'), 'buy_signal_v6_3')
...
class BinClucMadv1(ReDeCoredV1):
    INTERFACE_VERSION = 2
...
class BinClucMadv2(ReDeCoredV1):
    INTERFACE_VERSION = 2
...
class BinClucMadSMAv1(ReDeCoredV1):
...
class BinClucMadSMAv2(ReDeCoredV1):
